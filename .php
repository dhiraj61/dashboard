...
<div class="modal fade" id="studentProfileModal" tabindex="-1" role="dialog" aria-labelledby="studentProfileModalLabel" aria-hidden="true" data-backdrop="false" style="zindex:99999999999999">
  ...
  <div class="untree_co-hero overlay" style="background-image: url('images/hero-img-1-min.jpg');">
    ...
    if(isset($_SESSION['studentid'])){
        $id = $_SESSION['studentid'];
    ?>
        <div style="position:absolute;top:-15vw;left:-15vw;color:black;">
            <form action="" method="post">
        ...
        ?>
        <div style="position:absolute;top:-10vw;left:-24vw;color:black;font-size:2vw;">
            <?php echo "Total Present: $count"; ?>
        </div>

        <div style="position:absolute;top:-10vw;left:-3vw;color:black;font-size:2vw;">
            <?php echo "Total Lectures: $count2"; ?>
        </div>

        <div style="position:absolute;top:-3vw;left:-16vw;color:black;font-size:2vw;">
            <?php echo "Present Rate is : $count3 %"; ?>
        </div>

        <div style="position:absolute;top:3vw;left:-20vw;color:black;font-size:2vw;width:400px;height:300px">
...
<div class="container" style="width:45vw;position:absolute;top:-9vw;left:22vw">
