      ...
      <div class="head">
        ...
        <div class="right">
          <div class="right1">
            ...
            <h1 style="font-size:5vh;font-family:times new roman,times,serif">ADD FACULTY</h1>
                    ...
                    <div class="modal-body">
                      <form id="registerForm" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <input type="tel" class="form-control" id="phoneNumber" name="phoneNumber" pattern="[0-9]{1,10}">
                        </div>
                        <div class=" form-group">
