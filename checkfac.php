        ...
        <div class="head">
          ...
          <div class="right">
            <div class="right1">
              ...
              <h1 style="font-size:5vh;font-family:times new roman,times,serif">CHECK FACULTY</h1>
        ...
        <div class="sidebarmain">
          ...
          <div class="content">
            ...
            <div class="contents">
              ...
              <h1 style="text-align:center;margin:2vw 0;font-size:4vw;" class="f">Faculty</h1>
              <div style="margin:1vw 6vw;">
