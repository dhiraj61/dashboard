      ...
      <div class="sidebarmain">
        ...
        <div class="content">
          ...
          <div class="cards" style="font-family: 'Times New Roman', Times, serif;">
            ...
            <button class="btn btn-primary" style="font-size: 3vw;position:absolute;top:26%;margin-left: 5vw;color:white;border:none;background-color:transparent;"><?php echo $counts?></button>
            </div>
