        ...
        <div class="head">
            ...
            <div class="right">
                <div class="right1">
                    ...
                    <H1 style="font-size:5vh;font-family:times new roman,times,serif">LEARNING MATERIAL</H1>
                    <h1 class="text"></h1>
...
$emails=$_SESSION['email'];
    ...
    $imgs2=mysqli_fetch_array($result2);
            ...
            ?>
         <div class="right2" style="padding-right:7.7vw;">
          
         
          <div class="circle" style="">
          <h4><i class="fa-solid fa-circle " id="ar" style="font-size:3.6vw;"></i>   <i class="ri-arrow-down-s-fill arrow4" style="font-size:1.8vw;"> </i> <img src="<?php echo $imgs2['img']?>" alt="" width="58vw" height="56vw" style="position:absolute;right:10.8vw;border-radius:50%;border:none"></h4>
