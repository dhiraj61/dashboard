...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-Z2mM7XbMB9LkyJEz0P-9PwG9Ww8c+/pYyU79F5sckyJgtcBEkxpCUpRnmfbsXIlG" crossorigin="anonymous">
    <link
...
?>
      ...
      <div class="sidebarmain">
        ...
        <div class="content">
          ...
          <div class="container" style="width:40%;margin-top:2vw;">
            <div class="row  " id="y" style="">
                <div class="">
                    <h2 class="text-center">Publish Something</h2>
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3" >
                            <div class="custom-file" >
                                <input type="file" id="fileInput" name="file" class="custom-file-input" style="width:160%;height:120%;border-radius:5px;border:.1px solid black;">
                                <label class="custom-file-label" for="fileInput" style="border:1px solid black;">Choose PDF file</label>
                            </div>
                        </div>
                        <div class="form-group" style="margin-bottom:1vw;">
                            <input type="text" class="form-control" id="fileName" name="name" placeholder="Enter File Name" style="margin-bottom:1vw;">
        ...
        if (isset($_POST['upload'])) {
            ...
            $sql = "INSERT INTO notification (name,file,description) VALUES ('$name', '$folder','$description')";
        ...
        ?>
          ...
          <div class="not" style="background-color:#dadada;width:35%;height:100%;overflow-y:scroll">
   ...
   <div class="details">
       ...
       <h5 style="font-size:1vw;"><?php echo $row['description'] ?></h5>
   ...
   <div class="btn-group">
    ...
    if (isset($_POST['delete'])) {
        echo "<script>window.open('noticedel.php','_self');</script>";
    }
