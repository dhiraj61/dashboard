  ...
  <body>
    ...
    <div class="wrapper">
      <div class="head">
        ...
        <div class="right">
         <div class="right1" style="width:20vw;height:6vw;margin-left:1vw;">
          <!-- <h1><i class="fa-solid fa-bars"></i></h1> -->
          <h1 style="font-size:5vh;font-family:times new roman,times,serif">Attendance Report</h1>
          <h1 class="text"></h1>
...
<div style="margin-left:3vw;"><form method='post'>
