            ...
            <div class="col-lg-6"> 
                <div class="card shadow-sm">
                    <div class="card-header bg-transparent text-center">
                        ...
                        <p>Vimal Tormal Poddar BCA and BCom College</p> 
                    </div>
                    <div class="card-body">
...
$sql="update students set name='$name',email='$email',dob='$dob',phno='$phone',pmno='$pphone',sec='$section',course='$course',year='$year',semester='$semester',gender='$gender',address='$address',img='$folder' where student_id='$id'";

$res=mysqli_query($con,$sql);

if($res){
  
    echo "<script>window.open('checkstu.php','_self');</script>";
}
}
