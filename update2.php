            ...
            <div class="col-lg-6"> <!-- Adjust grid layout to make each card bigger -->
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>Qualification:</strong> <input type=" text" class="form-control" id="qual" name="qual" value="<?php echo $row['qual']?>" required>
...
$sql="update faculty set name='$name',email='$email',phone='$phone',experience='$expr',qual='$qual',dep='$dep',gender='$gender',address='$address',img='$folder' where fac_id='$id'";
