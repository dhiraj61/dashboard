            ...
            <div class="col-12" style="border-radius:20px;">
              <div class="custom-block" data-aos="fade-up" style="display:flex;align-items:center;justify-content:space-evenly;background-color:red;width:100%;gap:20vw;border-radius:20px;">
                <div class="accordion-info" style="display:flex;width:100%;align-items:center;justify-content:space-evenly;border-radius:20px;">
                  ...
                  <a href="<?php echo $row1['file'] ?>" class="pdf-viewer-icon" style="color:white;display:flex;"><i class="far fa-file-pdf" style="color:white;"></i>
                    <h6>View PDF</h6>
                  </a>
                </div>
              </div>
      ...
      <div class="owl-single owl-carousel no-nav">
        <div class="testimonial mx-auto">
          <figure class="img-wrap">
            <img src="https://toppng.com/uploads/preview/william-shakespeare-shakespeare-to-be-or-not-115629718480kdij02k1b.png" alt="Image" class="img-fluid bigger-image">
          </figure>
          <h3 class="name text-black bigger-text">William shakespeare</h3>
          <blockquote class="bigger-text">
            <p>&ldquo;There is nothing either good or bad, but thinking make it so&rdquo;</p>
          </blockquote>
        </div>

        <div class="testimonial mx-auto">
          <figure class="img-wrap">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Thomas_Edison2.jpg/640px-Thomas_Edison2.jpg" alt="Image" class="img-fluid bigger-image">
          </figure>
          <h3 class="name text-black bigger-text">Thomas Alva Edison</h3>
          <blockquote class="bigger-text">
            <p>&ldquo;Genius is one percent inspiration, ninety-nine percent perspiration.&rdquo;</p>
          </blockquote>
        </div>
